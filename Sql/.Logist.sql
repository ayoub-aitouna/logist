...
create TABLE OrderTable( id INT  AUTO_INCREMENT, Driver_ID int, user_id int, Date_of_Order DATE, Distination int, location int, Accepted BOOLEAN,
Canceled BOOLEAN,viecle_Id int,trailer_id INT,Current_Location int, Order_Type enum('Single','multiple shopment','multiple locations') NOT NULL,Order_Complited BOOLEAN, 
